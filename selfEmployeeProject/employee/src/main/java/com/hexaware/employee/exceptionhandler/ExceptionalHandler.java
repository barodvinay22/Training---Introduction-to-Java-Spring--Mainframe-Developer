...
public class ExceptionalHandler {
   @ExceptionHandler(ResourceNotFoundException.class)
    ...
    public ResponseEntity<CustomException> handleException(MethodArgumentNotValidException resourceNotFoundException){
        CustomException customException=new CustomException(resourceNotFoundException.getLocalizedMessage(),HttpStatus.NOT_FOUND);
